...
| 项目 | 主页 | 里面有什么 |
| --- | --- | --- |
| 🏢 **组织默认配置** | [`.github`](https://github.com/twojstar/.github) | 组织主页、社区文件、主页同步和组织级基础设施 |
| 🚗 **Autka** | [`twojstar/Autka`](https://github.com/twojstar/Autka) | Android/KMP 汽车信息聚合器及后端 |
| 🤖 **LlmBench** | [`twojstar/llmbench`](https://github.com/twojstar/llmbench) | 用于通过账户和免费提供商访问 LLM 的 Android 工作区 |
| 🐤 **Kanarek** | [`twojstar/kanarek`](https://github.com/twojstar/kanarek) | RSS/Atom 阅读器、小组件、广播/IPTV 和 Worker 后端 |
...
| 仓库 | PR | 标题 | 作者 | 状态 | 更新 |
| --- | ---: | --- | --- | --- | --- |
| twojstar/llmbench | [#61](https://github.com/twojstar/llmbench/pull/61) | feat: add Android share target | @trvny | 就绪 | 2026-09-05 |
| twojstar/twojstar | [#10](https://github.com/twojstar/twojstar/pull/10) | chore(deps-dev): bump the weather group across 1 directory with 3 updates | @dependabot[bot] | 就绪 | 2026-09-05 |
| twojstar/twojstar | [#11](https://github.com/twojstar/twojstar/pull/11) | chore(deps): bump actions/attest-build-provenance from 4.1.1 to 4.2.2 in the actions group | @dependabot[bot] | 就绪 | 2026-09-05 |
| twojstar/twojstar | [#12](https://github.com/twojstar/twojstar/pull/12) | Bump the dotnet group with 1 update | @dependabot[bot] | 就绪 | 2026-09-05 |
| twojstar/twojstar | [#14](https://github.com/twojstar/twojstar/pull/14) | chore(deps): bump the benches group across 1 directory with 3 updates | @dependabot[bot] | 就绪 | 2026-09-05 |
<!--OPEN_PRS:END-->
