...
| --- | ---: | --- | --- | --- | --- |
| twojstar/Autka | [#195](https://github.com/twojstar/Autka/pull/195) | deps(backend): bump the backend-minor-patch group in /backend with 3 updates | @dependabot[bot] | gotowy | 2026-09-07 |
| twojstar/Autka | [#196](https://github.com/twojstar/Autka/pull/196) | deps(backend): bump vitest from 4.1.11 to 5.0.0 in /backend | @dependabot[bot] | gotowy | 2026-09-07 |
| twojstar/llmbench | [#103](https://github.com/twojstar/llmbench/pull/103) | Open AI responses as Markdown assets | @trvny | gotowy | 2026-09-07 |
<!--OPEN_PRS:END-->
